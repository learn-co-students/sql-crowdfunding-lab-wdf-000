...
"SELECT users.name, SUM(pledges.amount) AS all_pledges FROM users INNER JOIN pledges ON users.id = pledges.user_id GROUP BY users.name ORDER BY all_pledges;"
end
